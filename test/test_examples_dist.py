...
class TestExamplesDist(TestCase, MultiProcessTestCase):
    ...
    def test_one_shot_allreduce_bias_rmsnorm(self):
        ...
        mod = import_path(EXAMPLES_DIR / "distributed" / "one_shot_allreduce_bias_rmsnorm.py")
        ...
        expected = mod.reference_one_shot_allreduce_bias_rmsnorm(x_ref, bias, weight, eps)
